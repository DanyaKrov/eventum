package com.example.eventum.mainPage.data.remote.dataSource
...
interface EventsRemoteDataSource {
    @GET("events/{id}")
    suspend fun getById(@Path("id") id: Long): EventResponse

    @PUT("events/{id}")
    suspend fun updateById(@Path("id") id: Long, event:EventRequest): EventResponse
